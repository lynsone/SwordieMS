...
sm.sendSayOkay("Go to Ludibrium and you'll encounter a bunch of #rGigantic Spirit Vikings#k. Observe them carefully, and when you feel like you've picked them apart, defeat #r150#k of them. I also need to see an evidence from you that you really did slay them all, so I want you bring #b50 Spirit Viking Tokens#k with you. If I see that you have really trained yourself in this session, then I'll teach you a new skill.")
