...
sm.sendSayOkay("The types of monsters you fight don't matter, but their level does. For you, #b#h0##k, I think you need to #rbattle Level 51 - 70 monsters#k. I think about #b200 monsters#k should do it. Remember, once this gauge is full, bring the counter back to me!")
