# 10839 | Starting Script

sm.setSpeakerID(2084001)
sm.sendNext("Today's job is to catch #bZeno#k, and then bring back #bZeno's Gloves#k.")
...
sm.sendSayOkay("Maybe if we bribed Anthony the Black Wing Captain, they would go easy on their surveillance. After thinking it through, I've decided to give a stuffed Zeno as a gift. But it's not easy to find, so I'll need your help.")
