# 10833 | Starting Script

sm.setSpeakerID(2084001)
sm.sendNext("Today's job is to catch #bMano#k, and then bring back Mano's #bRainbow-Colored Snail Shell#k.")
...
sm.sendSayOkay("Maybe if we bribed Anthony the Black Wing Captain, they would go easy on their surveillance. After thinking it through, I've decided to give him a stuffed Mano as a gift. But it's not easy to find, so I'll need your help.")
