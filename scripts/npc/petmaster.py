...
sm.sendNext("Hmm... are you raising one of my kids by any chance? I perfected a spell that uses Water of Life to blow life into a doll. "
            "People call it the #bPet#k. If you have one with you, feel free to ask me questions.")
    ...
    selection = answer
    if selection == 0:
        sm.sendNext("So you want to know more about Pets. Long ago I made a doll, sprayed Water of Life on it, and cast spell on it to create a magical animal. "
    ...
    response = sm.sendAskYesNo("250,000 mesos will be deducted. Do you really want to buy?")
