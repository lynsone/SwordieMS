...
public class LarknessManager {
    ...
    /**
     * Changes mode to dark if light, and vice versa. Includes decrementing feathers, and updating the net.swordie.ms.client.
     */
    ...
    /**
     * Sends a net.swordie.ms.connection.packet to update the net.swordie.ms.client's larkness state
     */
