...
//            getReturnEffectInfo().encode(outPacket); // ReturnEffectInfo::Decode
     ...
     * If it is valid, will set this Char's job, add all Skills that the job should have by default, and sends the info to the net.swordie.ms.client.
     *
     * @param id
     */
    ...
    /**
     * Adds a certain amount of money to the current character. Also sends the net.swordie.ms.connection.packet to update the net.swordie.ms.client's state.
     *
     ...
     * stats to the net.swordie.ms.client. Allows multi-leveling.
     *
    ...
    /**
     * Writes a net.swordie.ms.connection.packet to this Char's net.swordie.ms.client.
     *
