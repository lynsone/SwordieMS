...
public class ScriptManager implements Observer {
    ...
    /**
     * Sends a chat window with a text box the net.swordie.ms.client can enter text in.
     *
     * @param text        The text to display.
     * @param defaultText The default text of the text box for net.swordie.ms.client input.
    ...
    /**
     * Sends a chat window with a text box the net.swordie.ms.client can enter numbers in.
     *
     * @param text       The text to display.
    ...
    /**
     * Warps the net.swordie.ms.client to a given {@link Field} ID.
     *
    ...
    /**
     * Gives the net.swordie.ms.client mesos. Positive amount = add, Negative amount = deduct.
     *
    ...
    /**
     * Gives the net.swordie.ms.client a certain quantity of an item.
     *
     * @param id the item id to give
     * @param quantity the amount of items the net.swordie.ms.client gets. Does not do anything for equips
     */
    ...
    /**
     * Checks if the net.swordie.ms.client has a certain quantity of an item.
     *
     * @param id the item id
     * @param quantity the quantity of the item
     * @return whether or not the net.swordie.ms.client has <code>quantity</code> of the given item
     */
    ...
    /**
     * Checks if the net.swordie.ms.client has enough space in their inventory to hold an item.
     *
