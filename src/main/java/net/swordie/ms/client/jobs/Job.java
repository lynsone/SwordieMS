...
public abstract class Job {
    ...
    /**
     * Handles the initial part of a hit, the initial net.swordie.ms.connection.packet processing.
     * @param c The net.swordie.ms.client
     * @param inPacket The net.swordie.ms.connection.packet to be processed
     */
