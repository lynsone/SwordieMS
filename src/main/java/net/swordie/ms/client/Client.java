...
public class Client extends NettyClient {
    ...
    private net.swordie.ms.Channel channelInstance;
    ...
    public void setChannelInstance(net.swordie.ms.Channel channelInstance) {
        this.channelInstance = channelInstance;
    }

    public net.swordie.ms.Channel getChannelInstance() {
