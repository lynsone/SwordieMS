...
public enum InHeader {
    ...
    USER_NTARGET_FORCE_ATOM_ATTACK(632),
    USER_RUN_SCRIPT(633),
    ...
    MONSTER_COLLECI_COMPLETE_REWARD__REQ(643),
    MONSTER_COLLECI_EXPLORE__REQ(644),
    ...
    INVITE_PARTY_MATCH(886),
    CANCEL_INVITE_PARTY_MATCH(887),
    PARTY_MEMBER_CANDIDATE_REQUEST(888),
    URUS_PARTY_MEMBER_CANDIDATE_REQUEST(889),
    PARTY_CANDIDATE_REQUEST(890),
    INTRUSION_FRIEND_CANDIDATE_REQUEST(891),
    INTRUSION_LOBBY_CANDIDATE_REQUEST(892),
    END_PARTY_MATCH(893),
